...
from simulator.routers.nwc_opportunistic import find_route_energy_left2

class NwcEnergyLeftRouter(NwcAbstractRouter):

    def find_best_route(self, bundle, first_contact, **kwargs):
        # Call routing function
        return find_route_energy_left2(bundle_size=bundle.data_vol,
